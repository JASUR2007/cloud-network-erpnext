...
<li><code>.FY.</code> - ${__("Fiscal Year (requires Clothing System to be installed)")}</li>
<li><code>.ABBR.</code> - ${__("Company Abbreviation (requires Clothing System to be installed)")}</li>
				</ul>
       		</li>
    		</ul>
    Examples:
