...
const BankStatementImporter = () => {
    ...
    return (
        <div className="banking-importer-layout flex px-4 gap-4">
            <div className="banking-panel w-[52%]">
            ...
            <div className="banking-panel banking-panel--secondary w-[48%] border-s border-outline-gray-2 ps-4">
